  ...
  return (
    <section id="contact" className="py-20 bg-slate-950 relative overflow-hidden" ref={ref}>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            <div>
              ...
              <p className="text-slate-300 text-lg leading-relaxed mb-8">
                Whether you're looking to build a new application, optimize an existing system, or explore innovative
                solutions, I'm here to help turn your vision into reality.
              </p>
            </div>
        ...
        >
          <p className="text-slate-400">© 2024 Alex Johnson. Crafted with passion and precision.</p>
        </motion.div>
      </div>
    </section>
  )
