...
export default function Projects() {
  ...
  const projects = [
    ...
    },
    {
      ...
      description:
        "Secure, transparent voting platform built on Ethereum with smart contracts and decentralized identity verification.",
      image: "/placeholder.svg?height=300&width=500",
              ...
              <div className={`grid ${project.featured ? "lg:grid-cols-2" : "grid-cols-1"} gap-0`}>
                <div className="relative overflow-hidden">
                  ...
                  >
                    ...
                    <a
                      href={project.live}
                      className="p-2 bg-slate-900/80 backdrop-blur-sm rounded-full text-white hover:bg-purple-600 transition-colors duration-200"
                      data-interactive
                    >
